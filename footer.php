<!--Todo que estievrem usando essa variavél e que vão esta como item dentro do campo ACF de contato-->
...
<footer>
  <div class="footer">
    <div class="container">
      ...
      <div class="grid-4 footer_contato">
        <h3>Contato</h3>
        <ul>
          <!-- Campo esta dentro do ACF em contato, pos isso estou usando varivel Contato para indicar a pagina assim o telefone... reflete em todas as páginas < ?php $contato = get_page_by_title('contato'); ?>-->
  ...
  <div class="copy">
    <div class="container">
      <!-- Usando o prorpio php pra passar o ano
			    Se a pessoa mudar o nome da empresa dentro do wordpress vai mudar automaticamente < ?php bloginfo('name'); ?>
		  -->
